...
//import {Coord, Comm, PathSP} from './modules/hathor.module.js';
    ...
    var Bluetooth = class {
      ...
      async startComm () {
        let deviceOptions = {
          ...
          optionalServices: [
            ...
            this.statusC_UUID]};
        try {
          this.logDOM.innerHTML = this.time() + 'Requesting Horus Device...\n';      
          ...
          this.logDOM.innerHTML += this.time() + 'Connected to Horus on ESP32 Server.\n';
      ...
      */
      disconnectMsg (errorMsg) {
        this.logDOM.innerHTML += this.time() + errorMsg + '. Horus disconnected!\n';
...
Ui: {  
  ...
  /**
   * Combo DOM elements and their bindings associated with Celestial objects in the Navigation and Calibration windows, and Tracks in the NAvigation Window.
   * @memberof Ui
   */
  var itemsElements =
  {
  ...
  /**
   * Method called when Object Type combo DOM element is changed.
   * @memberof Ui
   * @param {Object} itemElement - A combo DOM element for the celestial objects and tracks types.
   */
  ...
  /**
   * Get the text typed in a filter DOM element and matches all celestial objects that contain the typed text corresponding to the celestial object type selected in the type combo DOM element.
   * The filtered objects are showed in a celestial object combo DOM element. 
   * @memberof Ui
  ...
  /**
   * Set the events keyup and click to the filter DOM element used to select a celestial object or configuration.
   * @memberof Ui
  ...
  /**
   * Create the options for a combo DOM element.
   * @memberof Ui
   * @param {Object} comboElement - a DOM select element.
  ...
  /**
   * Value from a select DOM element.
   * @memberof Ui
  ...
  /**
   * Text from a select DOM element.
   * @memberof Ui
   * @param {Object} element - Select element.
  ...
  /**
   * Value from a radio DOM element group.
   * @memberof Ui
  ...
  /**
   * Sets the properties of an input range DOM element.
   * @memberof Ui
  ...
  Controller: {
    ...
    /**
     * Updates the step size value shown next to the step size input range DOM element.
     * @memberof Ui.Controller
     */
  ...
  NavW: {
     ...
     * @memberof Ui.NavW
     * @param {string} timeOpt - 'now' to point to star now or 'date' to point to the star at a date and time specified at the el.objDate and el.objTime DOM elements.
     */
    ...
    /**
     * Function called when a new track is selected at the el.navTracksCombo DOM element. It actualizes the global variable trackCoords with the data of the selected track.
     * @memberof Ui.NavW
     */
  ...
  ConfigW: {    
    ...
    /**
     * Function called when a pointer input range config DOM element is changed to actualize the corresponding text with the input value.
     * @memberof Ui.ConfigW
